    ...
    if usr_cmd == "/start":
        ...
        await cmd.reply_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton("Support Group", url="https://t.me/Cartoonworldtelugu_india"),
                        InlineKeyboardButton("Bots Channel", url="https://t.me/Cartoonworldtelugu_india")
                    ],
                    [
                ...
                [
                    [
                        InlineKeyboardButton("Source Codes of Bot",
                                             url="https://Cartoonworldteluguindia.blogspot.com")
                    ],
                    [
                ...
                [
                    [
                        InlineKeyboardButton("Developer",
                                             url="https://t.me/Vamsi_2008_vamsi")
                    ],
                    [
                        InlineKeyboardButton("About Bot", callback_data="aboutbot"),
                        InlineKeyboardButton("Go Home", callback_data="gotohome")
        ...
        if Config.UPDATES_CHANNEL:
            ...
            try:
                ...
                if user.status == "kicked":
                    await cmd.message.edit(
                        text="Sorry Sir, You are Banned to use me. Contact my [Support Group](https://t.me/Vamsi_2008_vamsi).",
                        disable_web_page_preview=True
                    )
                    return
                ...
                await cmd.message.edit(
                    text="Something went Wrong. Contact my [Support](https://t.me/Vamsi_2008_vamsi).",
                    disable_web_page_preview=True
                )
                return
        await cmd.message.edit(
